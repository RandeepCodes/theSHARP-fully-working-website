...
<!-- Header Code -->
                ...
                <div class="col-xl-12">
                    <div class="page__banner-title">
                        ...
                        <div class="page__banner-title-menu">
                            <p style="color: white; font-size: 40px;">List of Rooms</p>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    $sql = "SELECT rt.room_type_id, r.room_no, rt.occupancy, rt.room_price, rt.room_description FROM room_type rt INNER JOIN room r ON rt.room_type_id = r.room_type_id";
    $result = $conn->query($sql);

    if ($result->num_rows > 0) {
        echo "<table>";
        echo "<tr><th>Room Type ID</th><th>Room No.</th><th>Occupancy</th><th>Price</th><th>Description</th></tr>";
